...
public class RideController {
	...
	public @ResponseBody Ride exceptionTest() {
		throw  new DataAccessException("Exception Handler") {
		};
	}
	
	@ExceptionHandler(RuntimeException.class)
	public ResponseEntity<ErrorHandler> genricError(RuntimeException ex)
	{
		ErrorHandler erhandler= new  ErrorHandler(HttpStatus.OK.value(), ex.getMessage());
		
		return  new ResponseEntity<ErrorHandler>(erhandler, HttpStatus.OK);
	}
